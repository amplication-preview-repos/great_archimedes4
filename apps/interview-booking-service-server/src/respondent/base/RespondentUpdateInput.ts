...
class RespondentUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => BookingUpdateManyWithoutRespondentsInput,
  })
  @ValidateNested()
  @Type(() => BookingUpdateManyWithoutRespondentsInput)
  @IsOptional()
  @Field(() => BookingUpdateManyWithoutRespondentsInput, {
    nullable: true,
  })
  bookings?: BookingUpdateManyWithoutRespondentsInput;
}

export { RespondentUpdateInput as RespondentUpdateInput };
