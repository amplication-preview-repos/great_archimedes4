...
@InputType()
class InterviewCreateNestedManyWithoutBookingsInput {
...
export { InterviewCreateNestedManyWithoutBookingsInput as InterviewCreateNestedManyWithoutBookingsInput };
